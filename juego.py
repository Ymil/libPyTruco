    ...
    def getStatusTheRound(self):
        ...
        if numberTheCurrentHand == 0:
            ...
            if resultCurrentHand['parda'] and self.getResultHandByNumber(numberThePreviusHand)['parda']:
                ...
                ''' C0: El jugador que gana la mano actual no es del mismo equipo que gano la mano anterior
                ...
                if numberTheCurrentHand == 2 and resultCurrentHand['player'].getTeam() == self.getResultHandByNumber(0)['player'].getTeam():
                    winner = self.getResultHandByNumber(0)
                elif numberTheCurrentHand == 2 and resultCurrentHand['player'].getTeam() == self.getResultHandByNumber(1)['player'].getTeam():
            ...
            while 1:
                ...
                while cJugadas < self.numberPlayers:
                    ...
                    while 1:
                        ...
                        if(not carta == 20):
                            if(jugador.playingCardInRound(carta)): #Juega la carta y se comprueba que este disponible
                ...
                self.actionGame.showResultaTheHand(Resultados['player'].getID(), Resultados['player'].getName(),  Resultados['player'].getTeam(),  1)
                if(self.statusGame == 0):
                    if(self.statusGame == 0):
                        self.actionGame.win(Resultados['player'].getTeam())
                    elif(self.statusGame == 2):
                        self.actionGame.winEmpate(Resultados['player'].getTeam())
