cards_dict = {
    ...
    '1_oro': [1, 'oro', 8],  '1_espada': [1, 'espada', 14],
    '1_basto': [1, 'basto', 13], '1_copa': [1, 'copa', 8],
    '2_oro': [2, 'oro', 9],  '2_espada': [2, 'espada', 9],
    '2_basto': [2, 'basto', 9],  '2_copa': [2, 'copa', 9],
    '3_oro': [3, 'oro', 10], '3_espada': [3, 'espada', 10],
    '3_basto': [3, 'basto', 10], '3_copa': [3, 'copa', 10],
    '4_oro': [4, 'oro', 1],  '4_espada': [4, 'espada', 1],
    '4_basto': [4, 'basto', 1],  '4_copa': [4, 'copa', 1],
    '5_oro': [5, 'oro', 2],  '5_espada': [5, 'espada', 2],
    '5_basto': [5, 'basto', 2],  '5_copa': [5, 'copa', 2],
    '6_oro': [6, 'oro', 3],  '6_espada': [6, 'espada', 3],
    '6_basto': [6, 'basto', 3],  '6_copa': [6, 'copa', 3],
    '7_oro': [7, 'oro', 11], '7_espada': [7, 'espada', 12],
    '7_basto': [7, 'basto', 4],  '7_copa': [7, 'copa', 4],
    '10_oro': [10, 'oro', 5], '10_espada': [10, 'espada', 5],
    '10_basto': [10, 'basto', 5], '10_copa': [10, 'copa', 5],
    '11_oro': [11, 'oro', 6], '11_espada': [11, 'espada', 6],
    '11_basto': [11, 'basto', 6], '11_copa': [11, 'copa', 6],
    '12_oro': [12, 'oro', 7], '12_espada': [12, 'espada', 7],
    '12_basto': [12, 'basto', 7], '12_copa': [12, 'copa', 7],
}
